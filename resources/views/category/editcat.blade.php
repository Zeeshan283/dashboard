        ...
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control" id="customer_id" name="menu_id" data-live-search="true">
                    <option value="" selected disabled>{{ $spmenu->name}}</option>
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-right-icon">
                    ...
                    <img id="imagePreviewDesktop" src="{{ $edit->img }}" alt="Image Description" style="max-width: 100px; max-height: 100px;">
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <div class="input-right-icon">
                    ...
                    <img id="imagePreviewMobile" src="{{ $edit->imgforapp }}" alt="Image Description" style="max-width: 100px; max-height: 100px;">
                </div>
            </div>
    </div>
