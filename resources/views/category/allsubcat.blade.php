...
@section('main-content')
        <div class="breadcrumb">
                ...
                <div class="col-md-6" style="text-align: right;  margin-left: auto;">
                    <a href="{{ route('sub-category.create')}}"><button class="btn btn-outline-secondary ladda-button example-button m-1" data-style="expand-left"><span class="ladda-label">Create Sub-Category</span></button></a>
                </div>
           </div>   
