...
@section('main-content')
    ...
    <div class="card-body">
        <button class="popup-button btn btn-primary col-md-1"
            style="color: white; position: relative; top: 10px; right: 10px;" onclick="toggleFilters()">Pending
            Filters</button><br><br>
        <div class="filter-card" id="filterCard">
            <form action="{{ route('pendingrefund') }}" method="GET">
    ...
    <div class="col-md-12 mb-4">
        <div class="card text-start">
            ...
            <div class="card-body">
                <h4 class="card-title mb-3">Pending Refund</h4>
