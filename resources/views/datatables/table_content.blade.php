            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('orderInvoice', $orders->id) }}" target="__BLANK"
                            class="btn btn-outline-secondary">Invoice</a>
                    </div>
                </td>
            </tr>
        @endforeach
        ...
        @foreach ($GetOrderDetails as $value => $orders)
            <tr>
                ...
                <td>
                    ...
                    <td>
                        @if ($orders->customer_cancel_status == 'Canceled')
                            <span class="badge-for-cancel"> {{ $orders->customer_cancel_status }} </span><br>
                            {{ $orders->customer_cancel_time }}
                        @else
                        @endif
                    </td>
    ...
    <tbody>
        @foreach ($data as $value => $orders)
            <tr>
                ...
                <td>{{ $orders->created_at }}</td>
                <td>
                    <img src="{{ $orders->product->url ?? null }}  " loading="lazy" width="50" height="50"
    ...
    <tbody>
        @foreach ($refund_status as $key => $refund)
            <tr>
                ...
                <td>
                    <img src="{{ $refund->product->url ?? null }}" loading="lazy" alt="Surprise" width="50"
                        height="50">
    ...
    <tbody>
        @foreach ($refund_status as $key => $refund)
            <tr>
                ...
                <td>
                    <img src="{{ $refund->product->url }}" loading="lazy" alt="Surprise" width="50"
                        height="50">
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    @if ($value->logo)
                        <td><img src="{{ asset($value->logo) }}" width="50" height="50" loading="lazy">
                        </td>
                    @else
                        <td>N/A</td>
                    @endif
        ...
        <tbody>
            @foreach ($banners as $key => $value)
                <tr>
                    ...
                    <td>{{ $value->title2 }}</td>
                    <td>{{ $value->offer }}</td>
                    <td><img src="{{ $value->image }}" width="50" height="50" alt="No"
                            loading="lazy"></td>
                    ...
                    <div class="row g-0">
                        <div class="col-3 d-flex justify-content-center p-3">
                            <div class="my-auto text-center">
                                <span class="text-13" style="font-size: 70px;"><i
