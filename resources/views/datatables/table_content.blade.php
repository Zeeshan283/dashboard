...
@elseif (Route::currentRouteName() == 'allcat' )
    ...
    <tbody>        
        ...
        <tr>
            ...
            <td class="col-lg-1" style="white-space: nowrap;">
                <a href="{{ route('category.editcat', ['id' => $allcat->id]) }}" class="btn rounded-pill btn-icon btn-outline-secondary">
                   <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
               </a>
    ...
    <tbody>
        @foreach ($data as $key=>$donor)
            <tr>
                ...
                <td>{{ $donor->slug }}</td>
                <td class="col-lg-1" style="white-space: nowrap;">
                    <a href="{{ asset('sub-category') }}/{{ $donor->id }}/edit" class="btn rounded-pill btn-icon btn-outline-secondary">
                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                    </a>
