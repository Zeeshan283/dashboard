    ...
    <tr>
        ...
        <form method="POST" action="{{ route('order.status', ['id' => $orders->id]) }}">
            ...
            <td class="d-flex 2">
                ...
                <button type="submit" class="btn btn-outline-secondary ladda-button example-button m-1" data-style="expand-left"><span class="ladda-label">Update</span></button>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <button type="submit" class="btn btn-outline-secondary ladda-button example-button m-1" data-style="expand-left"><span class="ladda-label">Invoice</span></button>
        </td>
    </tr>
    @endforeach
</tbody>
...
<tbody>
    ...
    <tr>
        ...
        <td>{{ $user->gender }}</td>
        <td>
            <a href="{{ route('user.edit', ['id' => $user->id]) }}" class="btn rounded-pill btn-icon btn-outline-secondary">
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <div class="d-flex gap-2">
                <a target="_blank" href="{{ URL::to('products/' . $product->id . '/edit') }}"><button type="button" class="btn btn-outline-secondary ">
    ...
    <tr>
        ...
        <td>
            ...
            <div class="rating d-flex flex-direction-right">
                @for ($i = 1; $i <= 5; $i++) <!-- <i class="nav-icon i-David-Star" style="color: {{ $i <= $rating ? '#f5c60b' : '#ccc' }}; font-size: 10px; margin-right: 5px;"></i> -->
...
<tbody>
    ...
    <tr>
        ...
        <td class="col-lg-1" style="white-space: nowrap;">
            ...
            <a href="{{ route('purchase.edit', ['purchase' => $purchase->id]) }}" class="btn rounded-pill btn-icon btn-secondary">
                <i class="fa fa-pencil-square-o" title="edit" aria-hidden="true"></i>
            </a>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="{{ route('purchase.bill', ['purchaseId' => $history->bill_number]) }}" class="btn btn-outline-secondary">View Bill</a>
            <a href="{{ route('purchase.invoice', ['purchaseId' => $history->purchase_id]) }}" class="btn btn-outline-secondary">Total Puchase</a>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex gap-2">
                    <a target="_blank" href="{{ route('pages.edit', ['page' => $value->id]) }}"><button type="button" class="btn btn-outline-secondary ">
                            <i class=" nav-icon i-Pen-2" title="edit" style="font-weight: bold;"></i>
                        </button></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex gap-2">
                    <a target="_blank" href="{{ route('faqs_categories.edit', ['faqs_category' => $value->id]) }}"><button type="button" class="btn btn-outline-secondary ">
                            <i class=" nav-icon i-Pen-2" style="font-weight: bold;"></i>
                        </button></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex gap-2">
                    <a target="_blank" href="{{ route('faqs.edit', ['faq' => $value->id]) }}"><button type="button" class="btn btn-outline-secondary ">
                            <i class=" nav-icon i-Pen-2" style="font-weight: bold;"></i>
                        </button></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex gap-2">
                    <a target="_blank" href="{{ URL::to('payment_method/' . $value->id . '/edit') }}"><button type="button" class="btn btn-outline-secondary ">
                            <i class=" nav-icon i-Pen-2" style="font-weight: bold;"></i>
                        </button></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex gap-2">
                    <a target="_blank" href="{{ URL::to('Deals/' . $product->id . '/edit') }}"><button type="button" class="btn btn-outline-secondary ">
                            <i {{-- class="fa fa-clone" --}} class=" nav-icon i-Pen-2" title="edit" style="font-weight: bold;"></i>
                        </button></a>
