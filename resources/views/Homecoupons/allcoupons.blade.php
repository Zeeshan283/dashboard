...
@section('main-content')
                ...
                <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="col-md-3">
                        <div class="dropdown">
                            <div class="dropdown-toggle" id="dropdownMenuButton8" data-toggle="dropdown"
                                ...
                                <p class="text-left">Coupon Type</p>
                            </div>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton8" style="max-width: 1000px;">
                                ...
                                <div class="dropdown-options">
                                    @foreach ($coupons as $key => $item)
                                        <label class="coupon_typeFilter">
                                            <input type="checkbox" value="{{ $item->coupon_type }}">
                    ...
                    <div class="col-md-3">
                        <div class="dropdown">
                            <div class="dropdown-toggle" id="dropdownMenuButton8" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <p class="text-left ">Coupon Title</p>
                            </div>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton8" style="max-width: 1000px;">
                                <input type="text" id="searchInput" onkeyup="filterOptions()" placeholder="Search...">
                                <div class="dropdown-options">
                                    @foreach ($coupons as $key => $item)
                                        <label class="coupon_titleFilter">
                                            <input type="checkbox" value="{{ $item->coupon_title ?: 'Nill' }}">
                                            <span class="option-text"> {{ $item->coupon_title ?: 'Nill' }}</span>
                                        </label>
                                    @endforeach
                                </div>
                    ...
                    <div class="col-md-3">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton8" style="max-width: 1000px;">
                                ...
                                <div class="dropdown-options">
                                    @foreach ($coupons as $key => $item)
                                        <label class="coupon_codeFilter">
                                            <input type="checkbox" value="{{ $item->coupon_code ?: 'Nill' }}">
                                            <span class="option-text"> {{ $item->coupon_code ?: 'Nill' }}</span>
                                        </label>
                                    @endforeach
                                </div>
                ...
                <div class="row" style="margin-top: 5px; margin-bottom: 180px;">
                    ...
                    <div class="col-md-3">
                        <div class="dropdown">
                            <div class="dropdown-toggle" id="dropdownMenuButton8" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <p class="text-left ">Store</p>
                            </div>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton8" style="max-width: 1000px;">
                                <input type="text" id="searchInput" onkeyup="filterOptions()" placeholder="Search...">
                                <div class="dropdown-options">
                                    @foreach ($coupons as $key => $item)
                                        <label class="storeFilter">
                                            <input type="checkbox" value="{{ $item->store ?: 'Nill' }}">
                                            <span class="option-text">{{ $item->store ?: 'Nill' }}</span>
                                        </label>
                                    @endforeach
                                </div>
    ...
    <div class="col-md-12 mb-4">
        <div class="card text-start">
            <div class="card-body">
                <h4 class="card-title mb-3">All Coupons</h4>
