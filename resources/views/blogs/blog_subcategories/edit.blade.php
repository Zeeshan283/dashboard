...
@section('main-content') 
    <div class="page-body">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="blog_sub_category_id" class="form-label">Sub Category</label>
                <input type="text" class="form-control" id="blog_sub_category_id" placeholder="Sub Category" name="blog_sub_category_id" value="{{ $edit->blog_sub_category_id }}" required>
            </div>
        </div>
                                            </div>
                                        </div>
