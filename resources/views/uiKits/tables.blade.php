                ...
                <div class="col-md-6 mb-3">
                    <div class="card text-start">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                Similar to tables and dark tables, use the modifier classes <code>.table-light</code> to make <code>
    thead
</code> appear light
                ...
                <div class="col-md-6 mb-3">
                    <div class="card text-start">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                Similar to tables and dark tables, use the modifier classes <code>.table-dark</code> to make <code>
        thead
    </code> appear Dark
