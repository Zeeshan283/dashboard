                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <span class="badge text-bg-primary m-2">Primary</span>
                            <span class="badge text-bg-secondary m-2">Secondary</span>
                            <span class="badge text-bg-success m-2">Success</span>
                            <span class="badge text-bg-danger m-2">Danger</span>
                            <span class="badge text-bg-warning m-2">Warning</span>
                            <span class="badge text-bg-info m-2">Info</span>
                            <span class="badge text-bg-light m-2">Light</span>
                            <span class="badge text-bg-dark m-2">Dark</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <span class="badge badge-pill text-bg-primary m-2">Primary</span>
                            <span class="badge badge-pill text-bg-secondary m-2">Secondary</span>
                            <span class="badge badge-pill text-bg-success m-2">Success</span>
                            <span class="badge badge-pill text-bg-danger m-2">Danger</span>
                            <span class="badge badge-pill text-bg-warning m-2">Warning</span>
                            <span class="badge badge-pill text-bg-info m-2">Info</span>
                            <span class="badge badge-pill text-bg-light m-2">Light</span>
                            <span class="badge badge-pill text-bg-dark m-2">Dark</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <span class="badge badge-pill text-bg-primary p-2 m-1">Primary</span>
                            <span class="badge badge-pill text-bg-secondary p-2 m-1">Secondary</span>
                            <span class="badge badge-pill text-bg-success p-2 m-1">Success</span>
                            <span class="badge badge-pill text-bg-danger p-2 m-1">Danger</span>
                            <span class="badge badge-pill text-bg-warning p-2 m-1">Warning</span>
                            <span class="badge badge-pill text-bg-info p-2 m-1">Info</span>
                            <span class="badge badge-pill text-bg-light p-2 m-1">Light</span>
                            <span class="badge badge-pill text-bg-dark p-2 m-1">Dark</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <a href="#" class="badge text-bg-primary m-2">Primary</a>
                            <a href="#" class="badge text-bg-secondary m-2">Secondary</a>
                            <a href="#" class="badge text-bg-success m-2">Success</a>
                            <a href="#" class="badge text-bg-danger m-2">Danger</a>
                            <a href="#" class="badge text-bg-warning m-2">Warning</a>
                            <a href="#" class="badge text-bg-info m-2">Info</a>
                            <a href="#" class="badge text-bg-light m-2">Light</a>
                            <a href="#" class="badge text-bg-dark m-2">Dark</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card mb-">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flash">
                                        ...
                                        <li class="list-group-item border-0">
                                            <span class="badge text-bg-primary w-badge">New</span>
                                            <span class="badge text-bg-dark w-badge">pending </span>
                                            <span class="badge text-bg-primary w-badge">203 </span>
                                            <span class="badge text-bg-success w-badge">hot </span>
                                            <span class="badge text-bg-warning w-badge">fixed </span>
                                            <span class="badge text-bg-info w-badge">in process </span>
                                            <span class="badge text-bg-danger w-badge">completed </span>

                                        </li>

                                        <h6 class="card-subtitle mt-2 mb-2 text-muted">Rounded badges examples:</h6>
                                        <li class="list-group-item border-0">
                                            <span class="badge text-bg-primary r-badge">New</span>
                                            <span class="badge text-bg-dark r-badge">pending </span>
                                            <span class="badge text-bg-primary r-badge">203 </span>
                                            <span class="badge text-bg-success r-badge">hot </span>
                                            <span class="badge text-bg-warning r-badge">fixed </span>
                                            <span class="badge text-bg-info r-badge">in process </span>
                                            <span class="badge text-bg-danger r-badge">completed </span>
