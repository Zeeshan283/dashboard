                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary w-100 m-1 mb-3">Primary</button>
                            <button type="button" class="btn btn-success w-100 m-1 mb-3">Success</button>
                            <button type="button" class="btn btn-warning w-100 m-1 mb-3">Warning</button>
                        </div>
                    </div>
                </div>
