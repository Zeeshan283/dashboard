            ...
            <div class="row mb-5">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Handles</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">More than two handles</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Range</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Stepping and snapping to values</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Non-linear sliders</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Tap</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Fixed dragging</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Drag</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Snap</h4>
                            ...
                            <div class="slider-example">
                                <h4 class="card-title text-start mb-4">Combined options</h4>
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">Range</h4>
                            <p class="text-start">The range mode uses the slider range to determine where the pips should be. A pip is generated for every percentage specified.
                            </p>
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-4">Left-to-Right (default)</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4">
                                <h4 class="card-title text-start mb-4">Right-to-Left</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">Positions</h4>
                            <p class="text-start">In positions mode, pips are generated at percentage-based positions on the slider. Optionally, the stepped option can be set to true to match the pips to the slider steps.
                            </p>
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-4">Positions</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4">
                                <h4 class="card-title text-start mb-4">Stepped positions</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">Count</h4>
                            <p class="text-start">The count mode can be used to generate a fixed number of pips. As with positions mode, the stepped option can be used.</p>
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-4">Count</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4">
                                <h4 class="card-title text-start mb-4">Stepped count</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">Values</h4>
                            <p class="text-start">The values mode is similar to positions, but it accepts values instead of percentages. The stepped option can be used for this mode.</p>
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-4">Values</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4">
                                <h4 class="card-title text-start mb-4">Stepped values</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">Primary color slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">success color slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">info color slider</h4>
                ...
                <div class="col-md-6 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">warning color slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">danger color slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">custom color slider</h4>
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">Default handle</h4>

                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3">extra large slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3"> large slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3"> default slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3"> small slider</h4>
                            ...
                            <div class="slider-example ps-4 pe-4 pb-4 ">
                                <h4 class="card-title text-start mb-3"> extra small slider</h4>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">CIRCLE FILLED HANDLE</h4>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">square FILLED HANDLE</h4>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">DEFAULT VERTICAL SLIDER</h4>

                            <div class="vertical-slider-example ps-4 pe-4 pb-4 ">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">CONNECT TO LOWER</h4>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">CONNECT TO Uper</h4>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-start mb-3">CONNECT TO Uper with tooltip</h4>

                            <div class="vertical-slider-example me-3 ps-4 pe-4 pb-4 ">
