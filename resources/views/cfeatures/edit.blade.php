        ...
        <div class="col-md-12" style="padding: 20px;">
            ...
            <div id="smartwizard" class="sw-theme-dots">
                ...
                <div>
                    <div id="step-2" class="">
                        <div class="card-body">
                            <form method="post" action="{{ route('cfeatures.update', [$edit->id]) }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="lectures"
                                                    placeholder="Total lectures" name="lectures"
                                                    value="{{ $edit->lectures }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="duration" class="form-label"
                                                    value="{{ $edit->duration }}">Duration</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="skilllevel" name="skilllevel">
                                                    <option value=""
                                                        @if (old('skilllevel', $edit->skilllevel) == '') selected @endif>Please Select
                                                    </option>
                                                    <option value="Basic Level"
                                                        @if (old('skilllevel', $edit->skilllevel) == 'Basic Level') selected @endif>Basic Level
                                                    </option>
                                                    <option value="Intermediate"
                                                        @if (old('skilllevel', $edit->skilllevel) == 'Intermediate') selected @endif>Intermediate
                                                    </option>
                                                    <option value="Expert Level"
                                                        @if (old('skilllevel', $edit->skilllevel) == 'Expert Level') selected @endif>Expert Level
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="language" name="language">
                                                    ...
                                                    <option value="English"
                                                        @if (old('language', $edit->language) == 'English') selected @endif>English
                                                    </option>
                                                    <option value="Urdu"
                                                        @if (old('language', $edit->language) == 'Urdu') selected @endif>Urdu</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="coursetype" name="coursetype">
                                                    <option value="Onsite"
                                                        @if (old('coursetype', $edit->coursetype) == 'Onsite') selected @endif>Onsite
                                                    </option>
                                                    <option value="Online"
                                                        @if (old('coursetype', $edit->coursetype) == 'Online') selected @endif>Online
                                                    </option>
                                ...
                                <div class="row col-lg-12">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group ml-6">
                                            ...
                                            @if ($edit->image)
                                                <img src="{{ asset('upload/trainings/' . $edit->image) }}"
