...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-s9sR2uQ1C6e3pUaGZeYOKwJ+1tK1OlR0J07qL0vE0vOm2/JZSBXLhDkf5ypQyQ2jj/7Vb8S0s1JSbm6G4FfFAg==" crossorigin="anonymous" />
<div class="breadcrumb">
                ...
                <div class="col-md-6" style="text-align: right;  margin-left: auto;">
                        <a href="{{ route('cfeatures.create') }}">
                        <button class="btn btn-outline-secondary ladda-button example-button m-1" data-style="expand-left"><span class="ladda-label">Add Course detail</span></button></a>
                </div>
</a>
    </div>
                    </div>
