                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="date" class="form-control" id="first_name" placeholder="Select Date" name="date" required>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" class="form-control" id="first_name" placeholder="Enter your Bill Number" name="bill_number" required>
                                                <small id="passwordHelpBlock" class="ul-form__text form-text ">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" id="product_sku" name="product_sku" data-live-search="true">
                                                    <option value="" selected disabled>Select Product SKU</option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="selected_product_name" id="selected_product_name" placeholder="Product Name"  readonly>
                                                <small id="passwordHelpBlock" class="ul-form__text form-text ">
                                                    Product Name
                                                </small>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                {{-- <input type="text" class="form-control" id="selected_product_name" value=""  readonly> --}}
                                                <input type="text" class="form-control" name="selected_product_model" id="selected_product_model" placeholder="Product Model No"  readonly>
                                                <small id="passwordHelpBlock" class="ul-form__text form-text ">
                                                    Product Name
                                                </small>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number" class="form-control" id="quantity" placeholder="Enter product quantity" name="quantity" required>
                                                <small id="passwordHelpBlock" class="ul-form__text form-text ">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="selected_product_price"  name="selected_product_price" placeholder="Product Cost"  required>
                                                <small id="passwordHelpBlock" class="ul-form__text form-text ">
                                                    Prodcut Cost 
                                                </small>
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="total_value" placeholder="Total Cost" name="total_value" readonly>
                                                <small id="passwordHelpBlock" class="ul-form__text form-text ">
                                                    Total Cost
                                                </small>
                                            </div>
