                ...
                <div>
                        ...
                        <div>
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <label for="staticEmail20"
                                        class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Product
                                    ...
                                    <label for="staticEmail19"
                                        class="ul-form__label ul-form--margin col-lg-1   col-form-label ">Model
                                        No:</label>
                                    <div class="col-lg-3 ">
                                    ...
                                    <label for="staticEmail20"
                                        class="ul-form__label ul-form--margin col-lg-1 col-form-label ">SKU:<span
                                    ...
                                    <label for="inputEmail4"
                                        class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Color</label>
                                    ...
                                    <br>
                                    <label for="inputEmail4"
                                        class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Make:</label>
                                    <div class=" col-lg-3 ">

                                        @if (Auth::User()->role == 'Admin')
                                            {!! Form::select('vendors', $vendors, null, [
                                                'id' => 'vendors',
                                        ...
                                        @else
                                            {!! Form::text('make1', Auth::User()->name, [
                                                'id' => 'make1',
                                                'class' => 'form-control',
                                                'disabled' => 'disabled',
                                            ]) !!}
                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <label for="staticEmail20"
                                                    class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Old
                                                    Price$:</label>
                                                <div class="col-lg-2">
                                                ...
                                                <label for="staticEmail20"
                                                    class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Sale
                                                    Price$:</label>
                                                <div class="col-lg-2">
                                                ...
                                                <label for="staticEmail20"
                                                    class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Warranty
                                                    Days:</label>
                                                <div class="col-lg-2">
                                                ...
                                                <label for="staticEmail20"
                                                    class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Return
                                                    Days:</label>
                                                <div class="col-lg-2">
                                                ...
                                                <label for="staticEmail20"
                                                    class="ul-form__label ul-form--margin col-lg-1 col-form-label ">MOQ:</label>
                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <label for="staticEmail20"
                                                    class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Refurbished
                                                    Price $:</label>
                                                <div class="col-lg-2    ">
                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <label for="staticEmail19" id="W_L"
                                                    class=" ul-form__label ul-form--margin col-lg-1  col-form-label ">Width:</label>
                                                ...
                                                <label for="staticEmail19" id="H_L"
                                                    class=" ul-form__label ul-form--margin col-lg-1  col-form-label ">Height:</label>
                                                ...
                                                <label for="staticEmail19" id="D_L"
                                                    class=" ul-form__label ul-form--margin col-lg-1  col-form-label ">Depth:</label>
                                                ...
                                                <label for="Weight"
                                                    class="ul-form__label ul-form--margin col-lg-1   col-form-label ">Select
                                                    Unit:</label>
                                                <div class="col-lg-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="staticEmail19" id="Weight_L"
                                                    class=" ul-form__label ul-form--margin col-lg-1  col-form-label ">weight:</label>
                    ...
                    <div id="step-3" class="">
                        ...
                        <div class="form-group row" style="padding-left: 50px;padding-right:50px">
                            ...
                            <label for="inputEmail4"
                                class="ul-form__label ul-form--margin col-lg-1 col-form-label">Menu:<span
                                    style="color: red;">*</span></label>
                            ...
                            <label for="inputEmail4"
                                class="ul-form__label ul-form--margin col-lg-1 col-form-label">Category:<span
                                    style="color: red;">*</span></label>
                            <div class="form-group col-lg-5">
                            ...
                            <label for="inputEmail4"
                                class="ul-form__label ul-form--margin col-lg-1 col-form-label">Sub Category:<span
                                    style="color: red;">*</span></label>
                            <div class="form-group col-lg-5">
                            ...
                            <label for="inputEmail4"
                                class="ul-form__label ul-form--margin col-lg-1 col-form-label">Brand:<span
                                    style="color: red;">*</span></label>
                            <div class="form-group col-lg-5">
                            ...
                            <div class="col-lg-5">
                                ...
                                @error('attachment')
                                    <span style="color: red;"
                                        class="invalid-feedback font-weight-bold">{{ $message }}</span
                                        style="color: red;">
                                @enderror
                            </div>
                            ...
                            <label for="staticEmail20"
                                class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Select Feature
                                Image(250x175)px:<span style="color: red;">*</span></label>
                            <div class="col-lg-5">
                            ...
                            <label for="staticEmail20"
                                class="ul-form__label ul-form--margin col-lg-1 col-form-label ">Select Images (mul)
                                (250x170)px:</label>
                            <div class="col-lg-5">
                            ...
                            <div class="card-block p-0">
                                <div>
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="staticEmail19"
                                                class="ul-form__label ul-form--margin col-lg-1   col-form-label ">Tax
                                                Title:</label>
                                            <div class="col-lg-3 ">
                                                <input type="text" id="tax_title" name="tax_title"
                                                    class="form-control">
                                    ...
                                    <div class="card">
                                        <div class="card-footer" style="text-align: right;">
                                            <button type="submit" name="submit"
                                                class="btn btn-outline-secondary  ladda-button example-button m-1">Submit</button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        $("#m_unit").change(function() {
            ...
            if (selectedValue === "Millimeter" || selectedValue === "Centimeter" || selectedValue ===
                "Inch" || selectedValue === "Meter") {
        ...
        $("#weight_unit").change(function() {
            ...
            if (selectedValue === "Ounce" || selectedValue === "Milligram" || selectedValue ===
                "Gram" || selectedValue === "Kilogram" || selectedValue === "MetricTon") {
