        ...
        <div class="col-md-12" style="padding: 20px;">
            ...
            <div id="smartwizard" class="sw-theme-dots">
                ...
                <div>
                    <div id="step-2" class="">
                        <div class="card-body">
                            <form method="post" action="{{ route('instructor.update',['instructor' => $edit->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card mb-4">
                                    <h5 class="card-header text-left"> Edit Instructor Information</h5>
                                    <hr class="my-0" />
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group" ml-10>
                                                    ...
                                                    <input type="text" class="form-control" id="name"
                                                        placeholder="Instructor Name" value="{{ $edit->name }}" name="name" required>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-6">
            <div class="form-group" ml-10>
                <label for="instructor" class="form-label">Training Category</label>
                <input type="text" class="form-control" id="instructor" placeholder="Training Category" name="instructor"  required>
            </div>
        </div> -->
