        ...
        <div class="col-md-12" style="padding: 20px;">
            ...
            <div id="smartwizard" class="sw-theme-dots">
                ...
                <div>
                    <div id="step-2" class="">
                        <div class="card-body">
                            <form method="post" action="{{ route('trainingCategories.update',['trainingCategory'=> $edit->id]) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group" ml-10>
                                                    <label for="training_category_id" class="form-label">Title</label>
                                                    <input type="text" class="form-control" id=" "
                                                        placeholder="Training Category" value="{{ $edit->title }}" name="title" required>
                                                </div>
                                            </div>
                                        </div>
