...
<div class="breadcrumb">
    ...
    <div class="col-md-6" style="text-align: right;  margin-left: auto;">
        <a href="{{ route('trainingCategories.create') }}">
...
<div class="col-md-12 mb-4">
    <div class="card text-start">
        <div class="card-body">
            <h4 class="card-title mb-3">All Training Categories</h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="{{ route('trainingCategories.edit',['trainingCategory' => $value->id]) }}"><button
                                    ...
                                    <form action="{{ route('trainingCategories.destroy', $value->id) }}" method="POST"
