    ...
    <div class="row">
        <div class="">
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6"><div class="card-title" style=" margin-left: -20px; ">Total Order Vs Sales</div></div>
                        <div class="col-6"><div class="card-title" style=" text-align: end; ">Total Orders: {{$allorders}} || Total Parcel's: {{$allparcels}}</div></div>
                    </div>
