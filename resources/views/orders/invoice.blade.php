            ...
            <div class="tm_invoice tm_style1" id="tm_download_section">
                        ...
                        <div class="tm_invoice_left">
                            <div class="tm_logo">
                                @if (Auth::user()->role == 'Admin')
                                    <img src="{{ asset('upload/logo/logo.png') }}" alt="Logo">
                            </div>
                        @else
                            <img src="/{{ $invoice->vendorProfile->logo }}" alt="Logo">
                        </div>
                        @endif
                    </div>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="tm_width_1 tm_semi_bold tm_primary_color tm_gray_bg">Parcel Id#</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($invoiceProduct as $value => $item)
                                        <tr>
                                            <td class="tm_width_1">{{ $item->id }}</td>
                                            ...
                                            <td class="tm_width_8"> <span style=" font-weight: 600; ">
                                                ...
                                                <div class="row">
                                                    ...
                                                    @php 
                                                        $isInCanceled = false;
                                                        foreach ($item->order_tracker as $tracker) {   
                ...
                <div class="tm_padd_20 tm_border tm_accent_border_20 tm_mb25">
                    ...
                    <div class="tm_grid_row tm_col_3 tm_align_center">
                        ...
                        <div class="  tm_accent_border_20 tm_border_none_sm">
                            ...
                            {{ $invoice->order->shipping_state ?? null }}
                            {{ $invoice->order->shipping_zipcode ?? null }},
                ...
                <div class="container">
                    <div class="row gx-0 justify-content-between" style="padding: 1px; ">
                        <div class="col-2">
                            <h6 class="tm_border_top_0 tm_bold tm_f16 tm_primary_color" style="text-align:center;">
                                Contact #
                            </h6>
