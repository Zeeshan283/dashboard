...
UI kits
                                        ...
                                        <a href="#">
                                            <i class="nav-icon me-2 i-Suitcase"></i> UI kits
                                           ...
                                           <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="{{ Route::currentRouteName()=='modals' ? 'open' : '' }}" href="{{route('modals')}}">
                                                    <i class="nav-icon me-2 i-Duplicate-Window"></i>
                ...
                Extra UI kits
                                        ...
                                        <a href="#">
                                            <i class="nav-icon i-Library me-2"></i> Extra UI kits
                                        </a><input type="checkbox" id="drop-2">
                                        <ul>
                                              <li class="nav-item">
                                        ...
                                        <ul>
                                            ...
                                            <li class="nav-item">
                                                <a class="{{ Route::currentRouteName()=='form-layouts' ? 'open' : '' }}" href="{{route('form-layouts')}}">
                                                    <i class="nav-icon me-2 i-Split-Vertical"></i>
                                            ...
                                            <li class="nav-item">
                                                <a class="{{ Route::currentRouteName()=='form-validation' ? 'open' : '' }}" href="{{route('form-validation')}}">
                                                    <i class="nav-icon me-2 i-Close-Window"></i>
...
Charts
                                        ...
                                        <a href="#">
                                            <i class="nav-icon me-2 i-Bar-Chart-5"></i> Charts
                                        </a><input type="checkbox" id="drop-2">
                                        <ul>

                                    <li class="nav-item">
                                        <a class="{{ Route::currentRouteName()=='echarts' ? 'open' : '' }}" href="{{route('echarts')}}" title='charts'>
                                            <i class="nav-icon me-2 i-Bar-Chart-2"></i>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <li><a  class="{{ Route::currentRouteName()=='apexAreaCharts' ? 'open' : '' }}" href="{{route('apexAreaCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Area </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexBarCharts' ? 'open' : '' }}" href="{{route('apexBarCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Bar </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexBubbleCharts' ? 'open' : '' }}" href="{{route('apexBubbleCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Bubble </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexColumnCharts' ? 'open' : '' }}" href="{{route('apexColumnCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Column </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexCandleStickCharts' ? 'open' : '' }}" href="{{route('apexCandleStickCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>CandleStick </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexLineCharts' ? 'open' : '' }}" href="{{route('apexLineCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Line </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexMixCharts' ? 'open' : '' }}" href="{{route('apexMixCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Mix </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexPieDonutCharts' ? 'open' : '' }}" href="{{route('apexPieDonutCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>PieDonut </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexRadarCharts' ? 'open' : '' }}" href="{{route('apexRadarCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Radar </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexRadialBarCharts' ? 'open' : '' }}" href="{{route('apexRadialBarCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>RadialBar </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexScatterCharts' ? 'open' : '' }}" href="{{route('apexScatterCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Scatter </a></li>
                                        <li><a  class="{{ Route::currentRouteName()=='apexSparklineCharts' ? 'open' : '' }}" href="{{route('apexSparklineCharts')}}">  <i class="nav-icon me-2 i-Bar-Chart-2"></i>Sparkline </a></li>
