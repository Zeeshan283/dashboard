                ...
                <div class="dropdown-menu text-start" aria-labelledby="dropdownMenuButton">
                    <div class="row m-0">
                        ...
                        <div class="col-md-4 p-4">
                            ...
                            <ul class="links">
                                <li><a href="{{ route('pendingorders')}}">Pendding</a></li>
                                <li><a href="alerts.html">Alerts</a></li>
                                <li><a href="{{ route('confirmedorders')}}">Confirmed</a></li>
                                <li><a href="{{ route('packagingorders')}}">Packaging</a></li>
                                <li><a href="{{ route('delivered')}}">Delivered</a></li>
            ...
            <div class="dropdown">
                <div class="user col align-self-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('signIn') }}">Sign out salkdlsad</a>
                    </div>
                </div>
            </div>
        </div>
