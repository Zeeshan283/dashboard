            ...
            <div class="border-end">
                <div class="pt-2 pb-2 ps-3 pe-3 d-flex align-items-center o-hidden box-shadow-1 chat-topbar">
                    <a data-sidebar-toggle="chat" class="link-icon d-md-none">
                        <i class="icon-regular ms-0 me-3 i-Left"></i>
                    </a>
                ...
                <div class="contacts-scrollable perfect-scrollbar">
                    <div class="mt-4 pb-2 ps-3 pe-3 font-weight-bold text-muted border-bottom">Recent</div>

                    <div class="p-3 d-flex align-items-center border-bottom online contact">
                        <img src="{{ asset('assets/images/faces/13.jpg') }}" class="avatar-sm rounded-circle me-3"
                            alt="">
                        <div>
                    ...
                    <div class="mt-3 pb-2 ps-3 pe-3 font-weight-bold text-muted border-bottom">Contacts</div>
