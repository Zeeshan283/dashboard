    ...
    <div id="task-manager">
            ...
            <div class="col-xl-10">
                <div class="navbar navbar-expand-lg navbar-light navbar-component rounded">
                    <div class="text-center d-lg-none w-100">
                        <button type="button" class="task-manager-button navbar-toggler text-white" data-toggle="collapse"
                    ...
                    <div class="navbar-collapse collapse" id="navbar-filter">
                        ...
                        <!-- <span class="navbar-text font-weight-semibold me-2 ms-md-auto">
                                                View mode:
                                            </span>
        ...
        <div class="row">
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                    <div>
                                        ...
                                        <p class="ul-task-manager__paragraph mb-3">A collection of textile samples lay
                                            spread out on the table..</p>

                                        <a href="#">
                                            <img src="{{ asset('assets/images/faces/1.jpg') }}" class="rounded-circle"
                                                width="36" height="36" alt="corrupted">
                                        </a>
                                        <a href="#">
                                            <img src="{{ asset('assets/images/faces/1.jpg') }}" class="rounded-circle"
                                                width="36" height="36" alt="corrupted 2">
                                        </a>
                                        <a href="#">
                                            <img src="{{ asset('assets/images/faces/1.jpg') }}" class="rounded-circle"
                                                width="36" height="36" alt="corrupted 2">
                                        ...
                                        <a href=""
                                            class="btn btn-icon bg-transparent border-slate-300 text-slate rounded-round border-dashed"><i
                                                class="icon-plus22"></i></a>
                                    </div>

                                    <ul class="list list-unstyled mb-0 mt-3 mt-sm-0 ms-auto">
                                        <li><span class="ul-task-manager__font-date text-muted">20 January, 2015</span>
                                        </li>
                                        <li class="dropdown">
                                            Priority: &nbsp;
                                            <a href="#" class="badge text-bg-danger align-top dropdown-toggle"
                                                data-toggle="dropdown">Blocker</a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item active"><span
                                                        class="badge badge-mark me-2 border-danger"></span> Blocker</a>
                                                <a href="#" class="dropdown-item"><span
                                                        class="badge badge-mark me-2 border-warning-400"></span> High
                                                    priority</a>
                                                <a href="#" class="dropdown-item"><span
                                                        class="badge badge-mark me-2 border-success"></span> Normal
                                                    priority</a>
                                                <a href="#" class="dropdown-item"><span
                                                        class="badge badge-mark me-2 border-grey-300"></span> Low
                                                    priority</a>
                                            </div>
                                        </li>
                            ...
                            <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center">
                                ...
                                <ul class="list-inline mb-0 mt-2 mt-sm-0">
                                    ...
                                    <li class="list-inline-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="#" class="dropdown-item"><i class="icon-alarm-add"></i> Check
                                                in</a>
                                            ...
                                            <a href="#" class="dropdown-item"><i class="icon-rotate-ccw2"></i>
                                                Reassign</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="#" class="dropdown-item"><i class="icon-pencil7"></i> Edit
                                                task</a>
                                ...
                                <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                    ...
                                    <ul class="list list-unstyled mb-0 mt-3 mt-sm-0 ms-auto">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item active"><span
                                                        class="badge badge-mark me-2 border-danger"></span>
                                                    Blocker</a>
                                                <a href="#" class="dropdown-item"><span
                                                        class="badge badge-mark me-2 border-warning-400"></span>
                                                    High priority</a>
                                                <a href="#" class="dropdown-item"><span
                                                        class="badge badge-mark me-2 border-success"></span>
                                                    Normal priority</a>
                                                <a href="#" class="dropdown-item"><span
                                                        class="badge badge-mark me-2 border-grey-300"></span>
                                                    Low priority</a>
                                            </div>
                                        </li>
                                        <li><a href="#">Eternity app</a></li>
            ...
            <div class="col-xl-3 ">
                ...
                <div class="card  mb-3">
                    ...
                    <div class="card-body" id="custom-toggle3">
                        ...
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action "><i class="i-Empty-Box">
                                </i> Create Project</a>
                            <a href="#" class="list-group-item list-group-item-action"><i class="i-Edit"> </i>
                                Edit Task List</a>
                            <a href="#" class="list-group-item list-group-item-action"><i class="i-Add-User">
                                </i> Assign User</a>
                            <a href="#" class="list-group-item list-group-item-action disabled"><i
                                    class="i-Network"> </i> Create Team </a>
                        </div>
                        <div class="mb-4"></div>
                        <!-- add task -->
                        ...
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action "><i class="i-Add-File">
                                </i> Active Tasks</a>
                            <a href="#" class="list-group-item list-group-item-action"><i
                                    class="i-File-Favorite"> </i> Closed Tasks</a>
                            <a href="#" class="list-group-item list-group-item-action"><i
                                    class="i-Administrator"> </i> Assigned To Me <span
                                    class="badge text-bg-primary badge-pill ms-4">14</span></a>
                            <a href="#" class="list-group-item list-group-item-action"><i class="i-Conference">
                                </i> Assigned To My Team <span class="badge text-bg-primary badge-pill ms-4">14</span></a>
                            <a href="#" class="list-group-item list-group-item-action"><i class="i-Gears"> </i>
                                Settings </a>
                ...
                <!-- completeness stats -->
                <div class="card  mb-3 ">
                    <div class="card-header font-weight-bold dropdown-toggle" onClick="customToggle6()">Completeness
                        Stats</div>
                    <div class="card-body" id="custom-toggle6">
                        <ul class="list-unstyled mb-0">
                            <li class="mb-3">
                                <div class="d-flex align-items-center mb-1">Blockers <span
                                        class="text-muted ms-auto">50%</span></div>
                            ...
                            <li class="mb-3">
                                <div class="d-flex align-items-center mb-1">High priority <span
                                        class="text-muted ms-auto">70%</span></div>
                                <div class="progress" style="height: 0.125rem;">
                            ...
                            <li class="mb-3">
                                <div class="d-flex align-items-center mb-1">Normal priority <span
                                        class="text-muted ms-auto">80%</span></div>
                                <div class="progress" style="height: 0.125rem;">
                            ...
                            <li>
                                <div class="d-flex align-items-center mb-1">Low priority <span
                                        class="text-muted ms-auto">60%</span></div>
                                <div class="progress" style="height: 0.125rem;">
