                ...
                <div class="flex-grow-1 d-bock">
                    <div
                        ...
                        <p class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges">
                            <span class="badge text-bg-info">20% off</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden mb-4 d-flex flex-column">
                ...
                <div class="flex-grow-1 d-bock">
                    <div
                        ...
                        <p class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges">
                            <span class="badge text-bg-info">-40%</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden mb-4 d-flex flex-column">
                ...
                <div class="flex-grow-1 d-bock">
                    <div
                        ...
                        <p class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges">
                            <span class="badge text-bg-info">10% off</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden mb-4 d-flex flex-column">
                ...
                <div class="flex-grow-1 d-bock">
                    <div
                        ...
                        <p class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges">
                            <span class="badge text-bg-info">4% off</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden mb-4 d-flex flex-column">
                ...
                <div class="flex-grow-1 d-bock">
                    <div
                        ...
                        <p class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges">
                            <span class="badge text-bg-success">$4 off</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card o-hidden mb-4 d-flex flex-column">
                ...
                <div class="flex-grow-1 d-bock">
                    <div
                        ...
                        <p class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges">
                            <span class="badge text-bg-primary">$5 off</span>
                        </p>
                    </div>
                </div>
            </div>
