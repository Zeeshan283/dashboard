                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="ul-product-detail__brand-name mb-4">
                                    ...
                                    <span class="text-mute">Modern model2022</span>
                                </div>

                                <div class="ul-product-detail__price-and-rating d-flex align-items-baseline">
                                    <h3 class="font-weight-700 text-primary mb-0 me-2">$2,300</h3>
                                    <span class="text-mute font-weight-800 me-2"><del>$1,150</del></span>
                        ...
                        <div class="tab-content ul-tab__content p-5" id="nav-tabContent">
                                        ...
                                        <div class="ul-product-detail__comment-list mt-3">
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">
                                                    <a href="" class="ul-product-detail__reply float-end">
                                                        <i class="i-Left"></i>
                                                        <span>Reply</span>
                                                    </a>
                            ...
                            <div class="tab-pane fade" id="nav-brand" role="tabpanel" aria-labelledby="nav-contact-tab">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <span class="badge badge-pill text-bg-danger p-2 m-1">Apple</span>
