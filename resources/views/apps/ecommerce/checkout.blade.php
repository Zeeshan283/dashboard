            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-basic-tab" data-toggle="tab" href="#homeBasic" role="tab"
                  ...
                  <i class="i-Credit-Card-2 text-danger text-16 align-middle me-1"></i>
              ...
              <li class="nav-item">
                <a class="nav-link" id="profile-basic-tab" data-toggle="tab" href="#profileBasic" role="tab"
                  ...
                  <i class="i-Paypal text-primary text-16 align-middle me-1"></i>
                  <span>Paypal</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="contact-basic-tab" data-toggle="tab" href="#contactBasic" role="tab"
                  ...
                  <i class="i-Bitcoin text-warning text-16 align-middle me-1"></i>
                  <span>Bitcoin</span>
                </a>
              </li>
            </ul>
