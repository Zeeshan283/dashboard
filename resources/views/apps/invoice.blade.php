                                ...
                                <form >
                                        ...
                                        <div class="col-md-3 offset-md-3 text-end">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="order-datepicker">Order Date</label>
                                                    <input id="order-datepicker" class="form-control text-end"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 text-end" >
                                            ...
                                            <div class="col-md-10 offset-md-2 form-group mb-3 pr-0">
                                                <textarea class="form-control text-end"
                                                    placeholder="Bill From Address"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 table-responsive">
                                            <table class="table table-hover mb-3">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>600</td>
                                                        <td>
                                                            <button class="btn btn-outline-secondary float-end">Delete</button>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
                                            ...
                                            <button class="btn btn-primary float-end mb-4">Add Item</button>
                                        </div>
