                            ...
                            <div class="search ul-task-manager__search-inline">
                                <nav class="navbar">
                                    <form class="d-flex align-items-center">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label me-2">Filter:</label>
                                        <input class="form-control me-sm-2" id="filterInput" type="search" placeholder="type to filter" aria-label="Search">
                                            ...
                                            <td class="custom-align">
                                                ...
                                                <div class="btn-group ">
                                                    ...
                                                    <div class="dropdown-menu ul-task-manager__dropdown-menu">
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-primary me-2"></span>Blocker</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-danger me-2"></span>High Priority</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-warning me-2"></span>Normal Priority</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-success me-2 "></span>Low Priority</a>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="custom-align">
                                                ...
                                                <div class="btn-group ">
                                                    ...
                                                    <div class="dropdown-menu ul-task-manager__dropdown-menu">
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-primary me-2"></span>Blocker</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-warning  me-2"></span>High Priority</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-danger  me-2"></span>Normal Priority</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-info  me-2 "></span>Low Priority</a>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="custom-align">
                                                <div class="btn-group ">
                                                    ...
                                                    <div class="dropdown-menu ul-task-manager__dropdown-menu">
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-primary me-2"></span>Blocker</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-danger me-2"></span>High Priority</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-success me-2"></span>Normal Priority</a>
                                                        <a class="dropdown-item" href="#"><span class="ul-task-manager__dot bg-warning me-2 "></span>Low Priority</a>
                                                    </div>
                                                </div>
                                            </td>
