            ...
            <div data-sidebar-container="main" class="inbox-main-sidebar-container">
                    ...
                    <div data-sidebar-container="secondary" class="inbox-secondary-sidebar-container box-shadow-1">
                        <div data-sidebar-content="secondary">
                            <div class="inbox-secondary-sidebar-content position-relative" style="min-height: 500px">
                                <div class="inbox-topbar box-shadow-1 perfect-scrollbar ps-3" data-suppress-scroll-y="true">
                                    ...
                                    <a data-sidebar-toggle="secondary" class="link-icon me-3 d-md-none">
                                        <i class="icon-regular me-1 i-Left-3"></i>
                                        Inbox
                                    </a>

                                    <div class="d-flex">
                                        <a href="" class="link-icon me-3"><i class="icon-regular i-Mail-Reply"></i>
                                            Reply</a>
                                        <a href="" class="link-icon me-3"><i class="icon-regular i-Mail-Reply-All"></i>
                                            Forward</a>
                                        <a href="" class="link-icon me-3"><i class="icon-regular i-Mail-Reply-All"></i>
                                            Delete</a>
                                    </div>
                                ...
                                <div class="inbox-details perfect-scrollbar" data-suppress-scroll-x="true">
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        <div class="">
                                            ...
                                            <p class="text-12 text-muted m-0">20 Dec, 2018</p>
                                        </div>
                                    </div>
                ...
                <div data-sidebar="main" data-sidebar-position="left" class="inbox-main-sidebar">
                    <div class="pt-3 pe-3 pb-3">
                        ...
                        <button class="btn btn-rounded btn-primary w-100 mb-4">Compose</button>
