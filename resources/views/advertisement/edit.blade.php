                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation"
                                method="POST"action="{{ route('advertisements.update', ['advertisement' => $edit->id]) }}"
                                            ...
                                            <div class="row">
                                                <div class="">
                                                    ...
                                                    <input class="upload d-none" type="file" name="image"
                                                        id="imageshow"><i class="fa fa-plus"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group mb-3  row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " id="validationCustom01" type="text"
                                                            required="" name="name" value="{{ $edit->name }}">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control " name="old_price"
                                                            ...
                                                            placeholder="100" value="{{ $edit->old_price }}"
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control" name="sale_price"
                                                            id="validationCustom02" type="text" required=""
                                                            placeholder="99" value="{{ $edit->sale_price }}"
                                                            onkeypress="return onlyDecimalNumberKey(event)">
                                                        {{-- <div class="valid-feedback">Looks good!</div> --}}
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="qty-box">
                                                            <div class="input-group">
                                                                <input class="qty-adj form-control" name="quantity"
                                                                    required type="text" value="{{ $edit->quantity }}"
                                                                    onkeypress="return onlyNumberKey(event)" />
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row product-adding">
                                    <div class="col-xl-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea id="details12" name="details">{{ $edit->details }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row product-adding">
