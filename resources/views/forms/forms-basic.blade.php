                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button class="btn btn-light rounded-pill rounded-start input-group-text"  type="button">
                                                <i class="icon-regular i-Calendar-4"></i>
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <label class="switch switch-secondary me-3">
                                <span>Secondary</span>
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="switch switch-success me-3">
                                <span>Success</span>
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="switch switch-warning me-3">
                                <span>Warning</span>
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="switch switch-danger me-3">
                                <span>Danger</span>
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="switch switch-light me-3">
                                <span>Light</span>
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="switch switch-dark me-3">
                                <span>Dark</span>
                                <input type="checkbox" checked>
                                <span class="slider"></span>
                            </label>
