                        ...
                        <div class="col-lg-4 col-xl-4 mt-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-outline-success ul-btn-raised--v2 m-1 float-end">Preview</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <button type="button" class="btn btn-outline-success ul-btn-raised--v2 m-1 float-end">Message</button>
                                    </div>
                                </div>
                            </div>
                        </div>
