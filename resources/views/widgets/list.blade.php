                                ...
                                <div class="tab-pane active show" id="__g-widget-s6-tab1-content">
                                    <div class="ul-widget-s6__items">
                                        ...
                                        <div class="ul-widget-s6__item">
                                            ...
                                            <p class="ul-widget-s6__text">
                                                System shutdown
                                                <span class="badge badge-pill text-bg-success  m-2">Primary</span>
                                            </p>
                                            <span class="ul-widget-s6__time">14 mins</span>
                                        </div>
                                        ...
                                        <div class="ul-widget-s6__item">
                                            ...
                                            <p class="ul-widget-s6__text">
                                                System shutdown
                                                <span class="badge badge-pill text-bg-danger  m-2">Primary</span>
                                            </p>
                                            <span class="ul-widget-s6__time">14 mins</span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="ul-widget-s6__items">
                                            ...
                                            <div class="ul-widget-s6__item">
                                                ...
                                                <span class="ul-widget-s6__text">System shutdown
                                                    <span
                                                        class="badge badge-pill text-bg-danger  m-2">Primary</span></span>
                                                <span class="ul-widget-s6__time">14 mins</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge text-bg-primary w-badge">Developing</span>
                                        </td>
                                        <td>
                                            <div id="chart13"></div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge text-bg-danger w-badge">Backend</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge text-bg-success w-badge">Frontend</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge text-bg-warning w-badge">Backend</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge text-bg-dark w-badge">Fullstack</span>
                                        </td>
                                        <td>
                        ...
                        <div class="ul-widget__payment-form">
                            <form action="">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-primary w-100 mb-3 mt-2">
                                        Confirm
                                    </button>
                                </div>
                            </form>
                            ...
                            <ul class="nav nav-pills nav-fill mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item ">
                                    <a class="nav-link active " id="pills-home-tab" data-toggle="pill"
                                        ...
                                        <i class="i-Credit-Card-2 text-16 me-2 align-middle"></i>
                                        Credit Card
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-home"
                                        ...
                                        <i class="i-Paypal text-16 me-2 align-middle"></i>
                                        Paypal
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-home"
                                        ...
                                        <i class="i-Bank text-16 me-2 align-middle"></i>
