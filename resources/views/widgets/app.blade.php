                    ...
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__task-list mb-4">
                            <label class="checkbox checkbox-primary">
                                ...
                                <span class="badge badge-pill text-bg-danger p-2 m-1 float-end">Today</span>
                                <span class="checkmark"></span>
                            </label>
                            <div class="ul-widget-app__work-list-img ms-4">
                        ...
                        <div class="ul-widget-app__task-list mb-4">
                            <label class="checkbox checkbox-primary">
                                <input type="checkbox">
                                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                                <span class="badge badge-pill text-bg-success p-2 m-1 float-end">Tomorrow</span>
                                <span class="checkmark"></span>
                            </label>
                            <div class="ul-widget-app__work-list-img ms-4">
                                <img class="profile-picture avatar-sm  rounded-circle"
                        ...
                        <div class="ul-widget-app__task-list mb-4">
                            <label class="checkbox checkbox-primary">
                                <input type="checkbox">
                                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                                <span class="badge badge-pill text-bg-info p-2 m-1 float-end">yesterday</span>
                                <span class="checkmark"></span>
                            </label>
                            <div class="ul-widget-app__work-list-img ms-4">
                                <img class="profile-picture avatar-sm  rounded-circle"
                        ...
                        <div class="ul-widget-app__task-list mb-4">
                            <label class="checkbox checkbox-primary">
                                <input type="checkbox">
                                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                                <span class="badge badge-pill text-bg-warning p-2 m-1 float-end">Week</span>
                                <span class="checkmark"></span>
                            </label>
                            <div class="ul-widget-app__work-list-img ms-4">
                                <img class="profile-picture avatar-sm  rounded-circle"
                        ...
                        <div class="ul-widget-app__task-list mb-4">
                            <label class="checkbox checkbox-primary">
                                <input type="checkbox">
                                <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit.</span>
                                <span class="badge badge-pill text-bg-primary p-2 m-1 float-end">Week</span>
                                <span class="checkmark"></span>
                            </label>
                            <div class="ul-widget-app__work-list-img ms-4">
                                <img class="profile-picture avatar-sm  rounded-circle"
                    ...
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__browser-list">
                            <div class="ul-widget-app__browser-list-1 mb-4 ">
                                <img class="profile-picture avatar-md  rounded-circle"
                                    src="{{ asset('assets/images/faces/4.jpg') }}" alt="">
                                <span class="text-15 ms-3">Sara Lanson</span>
                            ...
                            <div class="ul-widget-app__browser-list-1 mb-4 ">
                                <img class="profile-picture avatar-md  rounded-circle"
                                    src="{{ asset('assets/images/faces/3.jpg') }}" alt="">
                                <span class="text-15 ms-3">Jhon Legend</span>
                            ...
                            <div class="ul-widget-app__browser-list-1 mb-4 ">
                                <img class="profile-picture avatar-md  rounded-circle"
                                    src="{{ asset('assets/images/faces/2.jpg') }}" alt="">
                                <span class="text-15 ms-3">Chris Patt</span>
                            ...
                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <img class="profile-picture avatar-md  rounded-circle"
                                    src="{{ asset('assets/images/faces/1.jpg') }}" alt="">
                                <span class="text-15 ms-3">Vin Diesel</span>
                            ...
                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <img class="profile-picture avatar-md  rounded-circle"
                                    src="{{ asset('assets/images/faces/5.jpg') }}" alt="">
                                <span class="text-15 ms-3">Ryan reynolds</span>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__poll-list mb-4">
                            <h3 class="heading me-2">2589</h3>
                            <div class="d-flex">
                                <span class="text-muted text-12">From Uganda</span>
                                <span class="t-font-boldest ms-auto">
                                    33%
                        ...
                        <div class="ul-widget-app__poll-list mb-4">
                            ...
                            <div class="progress progress--height-2 mb-3">
                                <div class="progress-bar bg-dark" role="progressbar" style="width: 33%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>

                        <div class="ul-widget-app__poll-list mb-4">
                            <h3 class="heading me-2">3589</h3>
                            <div class="d-flex">
                ...
                <div class="card">
                    <div class="card-header purple-500 text-purple-500 p-4">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ul-widget-app__bar ms-auto">
                                asd
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__social-button mt-5">
                            <button type="button" class="btn w-100 btn-facebook btn-icon m-1">
                                <span class="ul-btn__text">Invite Facebook</span>
                                <span class="ul-btn__icon"><i class="i-Facebook-2"></i></span>
                            </button>

                            <button type="button" class="btn w-100 btn-twitter btn-icon m-1">
            ...
            <div class="col-lg-4 col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__browser-list">
                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Bell1  text-white bg-warning rounded-circle p-2  me-3"></i>
                                <span class="text-15">You have 9 pending Tasks</span>
                                <span class="text-mute">in a sec</span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Internet  text-white green-500 rounded-circle p-2  me-3"></i>
                                <span class="text-15">Traffic Overloaded</span>
                                <span class="text-mute">4 Hours ago</span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Shopping-Cart  text-white cyan-500 rounded-circle p-2  me-3"></i>
                                <span class="text-15">New Order Received</span>
                                <span class="text-mute">yesterday </span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Add-UserStar  text-white teal-500 rounded-circle p-2  me-3"></i>
                                <span class="text-15">New User </span>
                                <span class="text-mute">2 April </span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Bell  text-white purple-500 rounded-circle p-2  me-3"></i>
                                <span class="text-15">New Update </span>
                                <span class="text-mute">2 April </span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Shopping-Cart  text-white bg-danger rounded-circle p-2  me-3"></i>
                                <span class="text-15">New Order Received</span>
                                <span class="text-mute">yesterday </span>
                            </div>
                    ...
                    <div class="ul-widget-app__comments">
                        ...
                        <div class="ul-widget-app__row-comments">
                            ...
                            <div class="ul-widget-app__comment">
                                ...
                                <div class="ul-widget-app__profile-status">
                                    <span class="badge badge-pill text-bg-primary p-2 m-1">Pending</span>
                                    ...
                                    <span class="text-mute">May 14,2022</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ul-widget-app__row-comments">
                            ...
                            <div class="ul-widget-app__comment">
                                ...
                                <div class="ul-widget-app__profile-status">
                                    <span class="badge badge-pill text-bg-success p-2 m-1">Approved</span>
                                    <span class="ul-widget-app__icons">
                                        <a href=""> <i class="i-Approved-Window text-mute"></i></a>
                                        <a href=""> <i class="i-Like text-mute"></i></a>
                                        <a href=""><i class="i-Heart1 text-mute"></i></a>
                        ...
                        <div class="ul-widget-app__row-comments">
                            ...
                            <div class="ul-widget-app__comment">
                                ...
                                <div class="ul-widget-app__profile-status">
                                    <span class="badge badge-pill text-bg-danger p-2 m-1">Rejected</span>
                                    <span class="ul-widget-app__icons">
                                        <a href=""> <i class="i-Approved-Window text-mute"></i></a>
                                        <a href=""> <i class="i-Like text-mute"></i></a>
                                        <a href=""><i class="i-Heart1 text-mute"></i></a>
                        ...
                        <div class="ul-widget-app__row-comments">
                            ...
                            <div class="ul-widget-app__comment">
                                ...
                                <div class="ul-widget-app__profile-status">
                                    <span class="badge badge-pill text-bg-success p-2 m-1">Success</span>
                                    <span class="ul-widget-app__icons">
                                        <a href=""> <i class="i-Approved-Window text-mute"></i></a>
                                        <a href=""> <i class="i-Like text-mute"></i></a>
                                        <a href=""><i class="i-Heart1 text-mute"></i></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__recent-messages">
                            <div class="ul-widget-app__row-comments border-bottom-gray-200 mb-0">
                                <div class="ul-widget-app__profile-pic me-3">
                                    <img class="profile-picture avatar-md mb-2 rounded-circle img-fluid"
                                        src="{{ asset('assets/images/faces/1.jpg') }}" alt="">
                                </div>
                                <div class="ul-widget-app__comment">
                    ...
                    <div class="card-body">
                        <div class="user-profile mb-4">
                            <div class="ul-widget-card__user-info border-bottom-gray-200 pb-3">
                                <img class="profile-picture avatar-xl mb-2"
                                    src="{{ asset('assets/images/faces/4.jpg') }}" alt="">
                                ...
                                <div class="mt-3 ul-widget-app__skill-margin">
                                    ...
                                    <span data-toggle="tooltip" title="4 more" data-placement="top"
                                        class="badge badge-pill text-bg-primary p-2 m-1">+4</span>
                                </div>
                            </div>
                            <div class="ul-widget-app__profile-footer mt-4">
                                <div class="ul-widget-app__profile-footer-font">
                                    <a href="">
                                        <i class="i-Speach-Bubble-6 text-16 font-weight-600 me-1"></i>
                                        <span class=" text-16 font-weight-600">Message</span>
                                    </a>
                                </div>
                                <div class="ul-widget-app__profile-footer-font">
                                    <a href="">
                                        <i class="i-File-Clipboard-File--Text text-16 font-weight-600 me-1"></i>
            ...
            <div class="col-lg-4 col-xl-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class=" mt-2">
                            <button type="button" class="btn btn-primary w-100 m-1">Follow</button>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__browser-list">
                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Chrome  text-18 text-danger font-weight-600 me-3"></i>
                                <span class="text-15">Google Chrome</span>
                                <span class="badge badge-round-success pill  m-1">99%</span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Firefox  text-18 text-warning font-weight-600 me-3"></i>
                            ...
                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Internet-Explorer  text-18 text-info font-weight-600 me-3"></i>
                                <span class="text-15">Internet Explorer</span>
                                <span class="badge badge-round-primary pill  m-1">9%</span>
                            </div>

                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Opera  text-18 text-danger font-weight-600 me-3"></i>
                            ...
                            <div class="ul-widget-app__browser-list-1 mb-4">
                                <i class="i-Android  text-18 text-success me-3"></i>
            ...
            <div class="col-lg-4 col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="ul-widget-app__poll-list mb-4">
                            <div class="d-flex">
                                <h5 class="heading me-2">A</h5>
                                <span class="text-muted">20 Minutes</span>
                                <span class="t-font-boldest ms-auto">33%</span>
                            </div>
                            <div class="progress progress--height-2 mb-3">
                        ...
                        <div class="ul-widget-app__poll-list mb-4">
                            <div class="d-flex">
                                <h5 class="heading me-2">B</h5>
                                <span class="text-muted">Greater than 30 Minutes</span>
                                <span class="t-font-boldest ms-auto">63%</span>
                            </div>
                            <div class="progress progress--height-2 mb-3">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 55%"
                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        ...
                        <div class="ul-widget-app__poll-list mb-4">
                            <div class="d-flex">
                                <h5 class="heading me-2">C</h5>
                                <span class="text-muted">2 Hour</span>
                                <span class="t-font-boldest ms-auto">73%</span>
                            </div>
                            <div class="progress progress--height-2 mb-3">
                        ...
                        <div class="ul-widget-app__poll-list mb-4">
                            <div class="d-flex">
                                <h5 class="heading me-2">D</h5>
                                <span class="text-muted">8 Hour</span>
                                <span class="t-font-boldest ms-auto">13%</span>
                            </div>
                            <div class="progress progress--height-2 mb-3">
