                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="">
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputtext11" class="ul-form__label">Portfolio Category
                                                        1 :</label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="file" name="p_c1_images[]" id="imageInput_p"
                                                        class="form-control" multiple>
                                                    <button type="button" class="d-none form-control"
                                                        style="width: auto;"id="chooseImages_p">Choose Images</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputtext11" class="ul-form__label">Portfolio
                                                            Category 2 images:</label>

                                                        <input type="file" name="p_c2_images[]" id="imageInput_p1"
                                                            class="form-control" multiple>
                                                        <button type="button" class="d-none form-control"
                                                            style="width: auto;"id="chooseImages_p1">Choose
                                                            Images</button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputtext11" class="ul-form__label">Portfolio
                                                            Category 3 images:</label>

                                                        <input type="file" name="p_c3_images[]" id="imageInput_p3"
                                                            class="form-control" multiple>
                                                        <button type="button" class="d-none form-control"
                                                            style="width: auto;"id="chooseImages_p3">Choose
                                                            Images</button>
