        ...
        <div class="">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6"><div class="card-title" style=" margin-left: -20px; ">Total Supplier || Active Vs In Active </div></div>
                        <div class="col-6"><div class="card-title" style=" text-align: end; ">Total Supplier: {{$totalSupplier}} || Active: {{$totalActiveSupplier}} || InActive: {{$totalInActiveSupplier}}</div></div>
                    </div>
                    <div id="basicLine1"
