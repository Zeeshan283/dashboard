...
<form method="post" action="{{ route('helpcenter.store') }}">
    @csrf
    <div class="card mb-4">
            ...
            <div class="row">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <textarea name="question" id="question" class="form-control ckeditor" rows="8"></textarea>
                        
                    </div>
                    <div class="col-md-6">
                    <label for="answer" class="form-label">Answer</label>
                    <textarea name="answer" id="" class="form-control ckeditor" rows="8"></textarea>
                </div>
                </div>
            </div>
