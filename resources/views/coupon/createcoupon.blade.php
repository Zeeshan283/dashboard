            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('coupon.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="commonField" name="coupon_title"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="commonField" name="coupon_code"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control" id="commonField" name="minp"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="commonField" name="start_date"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="commonField" name="end_date"
                                ...
                                <div id="storeField4" class="form-group col-md-4" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" id="storeField4" name="store"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="field1"
                                                name="limit_same_user" placeholder="Limit For Same User">
                                            <small class="ul-form__text form-text">
                                                Limit For Same User
                                            </small>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-4 vendor2Fields">
                                            ...
                                            <input type="number" class="form-control" id="field2"
                                                name="limit_same_user1" placeholder="Limit For Same User">
                                            <small class="ul-form__text form-text">
                                                Limit For Same User
                                            </small>
                                        </div>
                                ...
                                <div id="vendor3Fields" style="display: none;">
                                    <div class="row">
                                        ...
                                        <div id="amountField3" class="form-group col-md-4" style="display: none;">
                                            ...
                                            <input type="text" class="form-control" id="amount" name="amount3"
                                                placeholder="Amount">
                                            <small class="ul-form__text form-text">
                                                Amount
                                            </small>
                                        </div>
                                        <div id="percentageField3" class="form-group col-md-4"
                                            style="display: none;">
                                            <label for="percentage3" class="ul-form__label">Percentage:</label>
                                            <input type="text" class="form-control" id="percentage"
                                                name="percentage3" placeholder="Percentage">
                                            <small class="ul-form__text form-text">
                                                Percentage
                                            </small>
                                        </div>
                        ...
                        <div class="form-group col-md-4">
                            <input type="text" class="form-control" id="commonField" name="status"
                                value="Active" hidden>
                        </div>
                            ...
                            <div class="mc-footer">
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <button type="submit" class="btn  btn-outline-secondary m-1">Create
                                            Coupon</button>

                                        <a href="{{ route('admin') }}"><button type="button"
                                                class="btn btn-outline-secondary m-1">Cancel</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
