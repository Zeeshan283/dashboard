...
$(document).ready(function () {
    ...
    e = {
        ...
        series: [
            { name: "menu Sprite", data: [44, 55, 41, 37, 22, 43, 21] },
    ...
    new ApexCharts(document.querySelector("#stackedBar"), e).render();
    e = {
        chart: { height: 350, type: "bar", stacked: !0, toolbar: { show: !1 } },
    ...
    new ApexCharts(document.querySelector("#negetiveBar"), e).render();
    e = {
        chart: { height: 350, type: "bar", toolbar: { show: !1 } },
        plotOptions: {
            bar: {
    ...
    new ApexCharts(document.querySelector("#customDatalabelBar"), e).render();
    e = {
        chart: {
            height: 350,
            type: "bar",
        ...
        stroke: { width: 2 },
        series: [
            { name: "Menu", data: [44, 55, 41, 37, 22, 43, 21] },
            { name: "Striking Calf", data: [53, 32, 33, 52, 13, 43, 32] },
            { name: "Tank Picture", data: [12, 17, 11, 9, 15, 11, 20] },
            { name: "Bucket Slope", data: [9, 7, 5, 8, 6, 9, 4] },
        ],
    ...
    new ApexCharts(document.querySelector("#PatternedBar"), e).render();
});
