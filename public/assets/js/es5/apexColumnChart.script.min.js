...
$(document).ready(function () {
    ...
    new ApexCharts(document.querySelector("#basicColumn-chart"), e).render();
    e = {
        chart: { height: 350, type: "bar", toolbar: { show: !1 } },
        plotOptions: {
            bar: { dataLabels: { position: "top" }, endingShape: "rounded" },
        },
        colors: ["#03A9F4"],
        dataLabels: {
            enabled: !0,
    ...
    new ApexCharts(document.querySelector("#columnDataLabel"), e).render();
    e = {
        chart: {
            height: 350,
            type: "bar",
        ...
        series: [
            { name: "Orders", data: [44, 55, 41, 67, 22, 43,44, 55, 41, 67, 22, 43,12,1] },
            { name: "Commission", data: [13, 23, 20, 8, 13, 27,13, 23, 20, 8, 13, 27,,12,4] },
        ],
        xaxis: {
            type: "datetime",
            categories: [
    ...
    new ApexCharts(document.querySelector("#stackedColumn"), e).render();
    e = {
        chart: { height: 350, type: "bar", toolbar: { show: !1 } },
        plotOptions: {
            bar: {
    ...
    new ApexCharts(document.querySelector("#negetiveColumn"), e).render();
    var t = [
        "#008FFB",
        "#00E396",
        "#FEB019",
    ...
    e = {
        ...
        xaxis: {
            ...
            labels: { style: { colors: t, fontSize: "14px" } },
        },
    };
    new ApexCharts(
